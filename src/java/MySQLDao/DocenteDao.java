...
public class DocenteDao implements IDocenteDao {
    ...
    public ArrayList<Docente> listarDocentes() {
        ...
        try {
            ...
            while (rs.next()) {
                docentes.add(new Docente(rs.getInt("idUsuario"),obtenerTipoDoc(rs.getInt("idTipoDocumento")),
                        rs.getString("numDoc"),
    ...
    public Docente obtenerDocente(int cod){
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery();
            while (rs.next()) {
                d = new Docente(rs.getInt("idUsuario"),obtenerTipoDoc(rs.getInt("idTipoDocumento")),
                        rs.getString("numDoc"),
                        rs.getString("correo"), rs.getDate("fechaNacimiento"),
                        rs.getString("tipoSangre"), rs.getString("ciudadActual"),
                        rs.getString("departamentoActual"), rs.getString("genero"),
