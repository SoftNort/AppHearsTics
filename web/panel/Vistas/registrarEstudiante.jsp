...
<!DOCTYPE html>
<%  session.setAttribute("paginaActual", "registrarEstudiante.jsp");
    ...
    <body> 
        ...
        <div class="main-wrapper">
            <div class="app" id="app">
                ...
                <form action="../UtilVistas/registrarEstudiante.jsp" method="post">
                                    ...
                                    <div class="card-block">
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active fade in" id="personal">
                                                <p class="title-description"> Datos Usuario </p>
                                                <div >
                                                    ...
                                                    <div class="form-group"> 
                                                        <label class="control-label" >Grupo</label><spand>*</spand>
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="usuario">
                                                ...
                                                <% if (tipo.getRol().equals("Administrador")) {%>
                                                <div class="form-group">
                                                    <label>Fecha de Vencimiento Pin</label>
                                                    <input type="date" name="fechaVencimiento" value="" class="form-control boxed" />
                                                </div>
                                                <%}%>
                                            </div>
                                        </div>
