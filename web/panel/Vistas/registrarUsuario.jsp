...
<!DOCTYPE html>
<%  session.setAttribute("paginaActual", "registrarUsuario.jsp");
    ...
    <body>
        ...
        <div class="main-wrapper">
            <div class="app" id="app">
                ...
                <form action="../UtilVistas/registrarUsuario.jsp" method="post">
                    <article class="content dashboard-page">
                        ...
                        <section class="section">
                                            ...
                                            <div role="tabpanel" class="tab-pane active fade in" id="personal">
                                                ...
                                                <div >
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="roles" id="roles" onclick="tipoUsuario()" class="form-control">
                            ...
                            <input type="hidden" id="rolInput" name="rol" value="">
