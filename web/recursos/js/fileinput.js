...
(function ($) {
    ...
    FileInput.prototype = {
        ...
        renderRemove: function () {
            ...
            return '<button type="button" id="remove" class="' + css + '"' + status + '>' + self.removeIcon + self.removeLabel + '</button>';
        },
        renderUpload: function () {
            ...
            if (isEmpty(self.uploadUrl)) {
                content = '<button type="button" id="enviarRespuesta" class="' + self.uploadClass + '"' + status + '>' + self.uploadIcon + self.uploadLabel + '</button>';
            }
            else {
